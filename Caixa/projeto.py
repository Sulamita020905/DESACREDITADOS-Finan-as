def main():
    ...
    print("Olá, seja bem-vindo(a) ao Supermercado MatSu! Fique à vontade para decidir o que comprar ;)")
    ...
    Disponível: Cartão, Dinheiro ou Pix""")
    #Adicionar forma de pagamento em VR e VA

    if forma_pagamento.lower() == 'cartao':
        tipo_cartao = input("Seria débito ou crédito? ")
